        ...
        <div>
          ...
          <div className="mt-10">
            <div className=" flex mt-5 justify-center">
              <h1 className="text-3xl sm:text-xs mob:text-sm tablet:text-4xl laptop:text-6xl laptopl:text-5xl text-bold mr-2">
                Let&apos;s
              </h1>
              <h1 className="text-3xl sm:text-xs mob:text-sm tablet:text-4xl laptop:text-6xl text-sky-400 laptopl:text-5xl text-bold mr-2">
                Work
              </h1>
              <h1 className="text-3xl sm:text-xs mob:text-sm tablet:text-4xl laptop:text-6xl laptopl:text-5xl text-bold mb-3">
                Together.
              </h1>
            </div>
